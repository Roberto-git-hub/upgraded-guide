...
Original file is located at
    https://colab.research.google.com/drive/14zJnmONRn3QR1vbuUT3z52w9sH5CID8e
"""
...
#             dag_count = 0.0
# 
#         # Identificação de Split flexível (String ou Decimal do Excel)
...
!streamlit run app.py & npx localtunnel -y --port 8501

# 1. Baixar o Cloudflare Tunnel
!wget -q -O cloudflared https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-amd64
!chmod +x cloudflared

# 2. Iniciar o Streamlit e abrir o tunnel
import subprocess
import time
